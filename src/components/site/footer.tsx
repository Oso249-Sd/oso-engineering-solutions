        ...
        <div className="space-y-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-primary-foreground/68">
          ...
          <div className="flex flex-wrap gap-2 text-xs text-primary-foreground/70">
            {content.footer.socials.map((social) => (
              <a
                ...
                className="rounded-full border border-white/15 px-3 py-1 transition hover:border-orange hover:text-orange"
              >
                {social.name}
              </a>
            ))}
